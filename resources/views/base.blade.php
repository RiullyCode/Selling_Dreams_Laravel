...
<head>
    ...
    <!-- favicon de la web -->
    <link rel="icon"
        href="https://cdn.discordapp.com/attachments/914613587715182622/1084148673883156511/favicon_selling_dreams.png"
        type="image/x-icon" />
    <!-- LINKS BOOTSTRAP -->
    <!-- CSS Bootrstrap -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="https://cdn.discordapp.com/attachments/914613587715182622/1084158119606759585/Logo_Proyecto.png"
                    alt="Logo" height="40" />
            </a>
            ...
            <form>
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  aria-describedby="registerPasswordConfirmHelp"
                  required
    ...
    <footer>
        <div class="footer-container">
            <div class="footer-logo">
                <a href=""><img
                        src="https://media.discordapp.net/attachments/914613587715182622/1084158119606759585/Logo_Proyecto.png?width=1112&height=582"
                        alt="Logo" /></a>
            </div>
